...
function insertDataIntoSheet(data, telegramAlert) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (existingIds.indexOf(id) === -1) {
      ...
      var warp_mode_distance_m = (details.warp_plus_mode_distance_m !== undefined) ? details.warp_mode_distance_m + details.warp_plus_mode_distance_m : details.warp_mode_distance_m;
      ...
      var warp_mode_distance_pct = (details.warp_plus_mode_distance_pct !== undefined) ? details.warp_mode_distance_pct + details.warp_plus_mode_distance_pct : details.warp_mode_distance_pct;
      ...
      var warp_mode_duration_s = (details.warp_plus_mode_duration_s !== undefined) ? details.warp_mode_duration_s + details.warp_plus_mode_duration_s : details.warp_mode_duration_s;
      ...
      var warp_mode_duration_pct = (details.warp_plus_mode_duration_pct !== undefined) ? details.warp_mode_duration_pct + details.warp_plus_mode_duration_pct : details.warp_mode_duration_pct;
