...
const TOP_AVG_SPEED_WK = GSHEETS.getSheetByName('TvAS-WK');
const DISTANCE_RANGE_WK = GSHEETS.getSheetByName('DvR-WK');
const DISTANCE_EFFICIENCY_WK = GSHEETS.getSheetByName('DvE-WK');
const DISTANCE_BATTERY_WK = GSHEETS.getSheetByName('DvB-WK');
const BATTERY_WK = GSHEETS.getSheetByName('Bat-WK');
